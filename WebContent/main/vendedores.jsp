...
<script>
    ...
    window.onload = function() 
    {
        ...
        {
            type: "GET",  
            url: "http://localhost:8180/inventariojeans/rest/services/vendedores",
            dataType: "json",  
    ...
    function getTarjetas()
    {
        ...
        {
            type: "GET",  
            url: "http://localhost:8180/inventariojeans/rest/services/tarjetas_by_vendedor/id_vendedor=" + id_vendedor,
            dataType: "json",  
            success: function(data)
            {
