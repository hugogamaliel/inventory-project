    ...
    onSelect: function (suggestion) 
    {
        ...
        var IDCliente = suggestion.data;
      	...
      	$.ajax(
			{
				type: "GET",  
				url: "http://DESKTOP-SI86HH8:8280/inventariojeans/rest/services/tarjetas/id_cliente=" + IDCliente,
				dataType: "json",  
				success: function(data)
				{
                    ...
                    for (i=0; i<sizeTarjetas; i++)
                    {
                        ...
                        if (data.tarjetas[i].saldo>0 && data.tarjetas[i].estado!="Cancelada")
                        {
					        ...
					        foo.setAttribute("onclick","javascript:abonarCuenta("+data.tarjetas[i].id_venta+");");
					        x.className = "boton";
					    }
